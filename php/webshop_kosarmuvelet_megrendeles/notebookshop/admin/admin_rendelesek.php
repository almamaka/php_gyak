    ...
    <div class="row justify-content-center">
        <table class="table tabel-striped text-center">
            ...
            <?php
                ...
                $sql = "SELECT vevok.id,vevok.nev,vevok.email,vevok.cim,rendelesek.szallitas,rendelesek.fizmod,rendelesek.datum,rendelesek.statusz,rendelesek.bosszeg FROM vevok INNER JOIN rendelesek ON vevok.id=rendelesek.vevoid ORDER BY vevok.id ASC";
